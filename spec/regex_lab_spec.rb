...
describe "Working with Regular expressions" do
  ...
  describe "#words_starting_with_un_and_ending_with_ing" do
    it "returns an array with the words starting with 'un' and ending with 'ing'" do
      words_string = "unassuming ambiguous understanding learning pomp circumstance uninteresting unworthy uncompromising grouchy corollary"
      ...
      expect(words_starting_with_un_and_ending_with_ing(words_string)).not_to include("learning")
      expect(words_starting_with_un_and_ending_with_ing(words_string)).not_to include("unworthy")
    end
  end
